                ...
                <div className="container flex flex-col items-center justify-center px-5 mx-auto md:flex-row text-gray-700">
                    <div className="w-full lg:w-1/2 mx-8">
                        ...
                        <p className="text-2xl md:text-3xl font-light leading-normal mb-8">
                            Sorry we could not find the page you are looking for <span className="text-teal-400 font-bold">{location.pathname.charAt(1).toUpperCase() + location.pathname.slice(2)}</span>
                        </p>
